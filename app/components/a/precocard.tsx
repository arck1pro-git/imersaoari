...
export default function Precocard() {
    ...
    return (
<section className="py-12 px-6 font-montserrat">
  <div className="max-w-lg mx-auto">
    ...
    >
      <div className="bg-zinc-950 p-10 text-center" style={{ borderRadius: "calc(1.5rem - 1.5px)" }}>
        ...
        <ModalTrigger className="block mx-auto w-fit button-sun font-bold uppercase tracking-widest px-8 py-4 text-sm">
          GARANTIR MINHA VAGA
        </ModalTrigger>
