export default function Duvidas() {
  return (
    <section className="bg-black text-white py-12 px-6 text-center relative overflow-hidden font-montserrat">
      <div className="relative z-10">
        <h2 className="text-3xl md:text-4xl font-bold font-montserrat gradient-text mb-3">
