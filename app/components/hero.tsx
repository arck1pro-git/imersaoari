  ...
  return (
    <section className="relative min-h-screen overflow-hidden flex flex-col lg:pt-24">
      ...
      <div className="absolute inset-0 z-0 hidden sm:block">
        <Image src="/hero.webp" alt="" width={1920} height={1080} className="absolute top-0 right-0 h-full w-auto" priority />
      ...
      <div className="block lg:hidden w-full relative z-10">
        <Image src="/hero.webp" alt="" width={800} height={450} className="w-full h-72 object-cover object-top" priority />
