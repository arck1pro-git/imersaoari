...
export default function RootLayout({
  ...
  return (
    <html
      ...
      lang="pt-BR"
      className={` ${manrope.variable} ${inter.variable} ${carlaSans.variable} antialiased`}
    >
      <body suppressHydrationWarning className="bg-black font-inter min-h-full flex flex-col">
